...
public class TestProcessGroupAuditor {
    ...
    private final NiFiUser user = new StandardNiFiUser.Builder().identity(USER_ID).build();
    ...
    void testVerifyEnableControllerServicesAuditing() {
        ...
        assertEquals(user.getIdentity(), pgAction.getUserIdentity());
        ...
        assertEquals(user.getIdentity(), csAction.getUserIdentity());
